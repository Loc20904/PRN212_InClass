...
namespace DE180158WPF.ViewModel
{
    public class CustomerManagerViewModel : INotifyPropertyChanged
    {
        ...
        {
            Customers = new ObservableCollection<Customer>(_dao.GetAll());
        ...
        {
            var fresh = new Customer { CustomerStatus = 1, CustomerBirthday = DateTime.Today };
        ...
        private void DeleteSelected()
        {
            ...
            {
                _dao.Delete(SelectedCustomer!.CustomerID);
