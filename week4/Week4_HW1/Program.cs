...
namespace DelegatesLinQ.Homework
{
    ...
    public class EventCalculator
    {
        ...
        public double Divide(double a, double b)
        {
            ...
            if (b == 0)
            {
                ErrorOccurred?.Invoke("Divide", "Division by zero is not allowed.");
    ...
    public class CalculationAuditor
    {
        ...
        {
            _operationCount++;
            Console.WriteLine($"Auditor: Operation '{operation}' performed. Total operations: {_operationCount}");
        }
    ...
    public class ErrorHandler
    {
        ...
        public void OnErrorOccurred(string operation, string errorMessage)
        {
            Console.WriteLine($"Error Handler: An error occurred during '{operation}': {errorMessage}");
        }
    }
