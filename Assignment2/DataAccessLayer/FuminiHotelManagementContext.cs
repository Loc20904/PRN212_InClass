...
public partial class FuminiHotelManagementContext : DbContext
{
    ...
    {
        IConfiguration configuration = Util.GetConfiguration();
        return configuration["ConnectionStrings:MiniHotelDB"];
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasIndex(e => e.EmailAddress, "UQ__Customer__49A1474067147886").IsUnique();
